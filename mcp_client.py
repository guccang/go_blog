...
class MCPClient:
    def __init__(self, llm_client, model_name: str, tools: List[Any]):
    ...
    async def process_query(self, query: str, selected_tools: List[str], temperature: float = 0.7) -> str:
        """Use LLM and MCP server tools to process query"""
        messages = [
            {
                "role": "system",

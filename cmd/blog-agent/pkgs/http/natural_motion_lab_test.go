...
func TestNaturalMotionLabOwnsCeladonRainSample(t *testing.T) {
	...
	for _, expected := range []string{
		...
		`/css/celadon_rain_lab.css?v=6`, `/js/celadon_rain_lab.js?v=10`,
		`data-celadon-setting="wind"`, `data-celadon-setting="lightAngle"`,
		`data-celadon-setting="lightRange"`, `data-celadon-setting="mediumDensity"`,

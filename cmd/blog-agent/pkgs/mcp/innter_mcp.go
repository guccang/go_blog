...
func RegisterInnerTools() {
	...
	RegisterCallBack("RawDeleteGoalTask", Inner_blog_RawDeleteGoalTask)
	RegisterCallBack("RawDeleteGoal", Inner_blog_RawDeleteGoal)
	RegisterCallBack("RawListGoalsByLevel", Inner_blog_RawListGoalsByLevel)
	RegisterCallBack("RawPrevPeriod", Inner_blog_RawPrevPeriod)
	RegisterCallBack("RawNextPeriod", Inner_blog_RawNextPeriod)

	// 明确的目标查询工具 (自动计算周期，LLM友好)
	RegisterCallBack("RawGetDailyGoal", Inner_blog_RawGetDailyGoal)
	RegisterCallBack("RawGetWeeklyGoal", Inner_blog_RawGetWeeklyGoal)
	RegisterCallBack("RawGetMonthlyGoal", Inner_blog_RawGetMonthlyGoal)
	RegisterCallBack("RawGetYearlyGoal", Inner_blog_RawGetYearlyGoal)

	// 便捷目标操作工具 (对标 Todo 的简洁度，自动计算周期)
	RegisterCallBack("RawAddDailyGoalTask", Inner_blog_RawAddDailyGoalTask)
	...
	RegisterCallBack("RawMemoryRewriteSection", Inner_blog_RawMemoryRewriteSection)
...
func GetInnerMCPTools(toolNameMapping map[string]string) []LLMTool {
	...
	*/
	...
	tools := []LLMTool{
		...
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawCreateProject", Description: "创建新项目，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "name": map[string]string{"type": "string", "description": "项目名称"}, "description": map[string]string{"type": "string", "description": "项目描述"}, "status": map[string]string{"type": "string", "description": "状态 planning/active/on_hold/completed/cancelled"}, "priority": map[string]string{"type": "string", "description": "优先级 low/medium/high/urgent"}, "owner": map[string]string{"type": "string", "description": "负责人"}, "startDate": map[string]string{"type": "string", "description": "开始日期 YYYY-MM-DD"}, "endDate": map[string]string{"type": "string", "description": "结束日期 YYYY-MM-DD"}, "tags": map[string]string{"type": "string", "description": "标签,多个用逗号分隔"}}, "required": []string{"account", "name"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawGetProject", Description: "获取指定项目详情，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}}, "required": []string{"account", "projectID"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawListProjects", Description: "获取项目列表，支持按状态筛选，返回JSON(list)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "status": map[string]string{"type": "string", "description": "状态筛选，可选"}}, "required": []string{"account"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawUpdateProject", Description: "更新项目信息，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}, "name": map[string]string{"type": "string", "description": "项目名称"}, "description": map[string]string{"type": "string", "description": "项目描述"}, "status": map[string]string{"type": "string", "description": "状态"}, "priority": map[string]string{"type": "string", "description": "优先级"}, "owner": map[string]string{"type": "string", "description": "负责人"}, "startDate": map[string]string{"type": "string", "description": "开始日期 YYYY-MM-DD"}, "endDate": map[string]string{"type": "string", "description": "结束日期 YYYY-MM-DD"}, "tags": map[string]string{"type": "string", "description": "标签,多个用逗号分隔"}}, "required": []string{"account", "projectID"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawDeleteProject", Description: "删除项目，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}}, "required": []string{"account", "projectID"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawAddProjectGoal", Description: "为项目添加目标，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}, "title": map[string]string{"type": "string", "description": "目标标题"}, "description": map[string]string{"type": "string", "description": "目标描述"}, "status": map[string]string{"type": "string", "description": "状态 pending/in_progress/completed/cancelled"}, "priority": map[string]string{"type": "string", "description": "优先级"}, "progress": map[string]interface{}{"type": "number", "description": "进度 0-100"}, "startDate": map[string]string{"type": "string", "description": "开始日期 YYYY-MM-DD"}, "endDate": map[string]string{"type": "string", "description": "结束日期 YYYY-MM-DD"}}, "required": []string{"account", "projectID", "title"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawUpdateProjectGoal", Description: "更新项目目标，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}, "goalID": map[string]string{"type": "string", "description": "目标ID"}, "title": map[string]string{"type": "string", "description": "目标标题"}, "description": map[string]string{"type": "string", "description": "目标描述"}, "status": map[string]string{"type": "string", "description": "状态"}, "priority": map[string]string{"type": "string", "description": "优先级"}, "progress": map[string]interface{}{"type": "number", "description": "进度 0-100"}, "startDate": map[string]string{"type": "string", "description": "开始日期 YYYY-MM-DD"}, "endDate": map[string]string{"type": "string", "description": "结束日期 YYYY-MM-DD"}}, "required": []string{"account", "projectID", "goalID", "title", "status", "priority"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawDeleteProjectGoal", Description: "删除项目目标，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}, "goalID": map[string]string{"type": "string", "description": "目标ID"}}, "required": []string{"account", "projectID", "goalID"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawAddProjectOKR", Description: "为项目添加OKR，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}, "objective": map[string]string{"type": "string", "description": "Objective"}, "status": map[string]string{"type": "string", "description": "状态 draft/active/at_risk/completed/cancelled"}, "period": map[string]string{"type": "string", "description": "周期"}, "progress": map[string]interface{}{"type": "number", "description": "进度 0-100"}}, "required": []string{"account", "projectID", "objective"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawUpdateProjectOKR", Description: "更新项目OKR，返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "projectID": map[string]string{"type": "string", "description": "项目ID"}, "okrID": map[string]string{"type": "string", "description": "OKR ID"}, "objective": map[string]string{"type": "string", "description": "Objective"}, "status": map[string]string{"type": "string", "description": "状态"}, "period": map[string]string{"type": "string", "description": "周期"}, "progress": map[string]interface{}{"type": "number", "description": "进度 0-100"}}, "required": []string{"account", "projectID", "okrID", "objective", "status"}}}},
		...
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawSaveGoal", Description: "保存目标概述、判据和状态。judge 为客观完成判据(独立判官评审依据,防乐观停止)。返回JSON({success:true})", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "level": map[string]string{"type": "string", "description": "目标层级:daily/weekly/monthly/yearly"}, "period": map[string]string{"type": "string", "description": "周期标识"}, "overview": map[string]string{"type": "string", "description": "目标描述"}, "judge": map[string]string{"type": "string", "description": "客观完成判据(如:体重记录≤72kg / 本周exercise记录≥3),可选"}, "status": map[string]string{"type": "string", "description": "状态:active/completed/archived"}}, "required": []string{"account", "level", "period"}}}},
		...
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawUpdateGoalTask", Description: "更新目标子任务的状态/标题/描述/优先级。cortana可通过此接口标记任务完成。返回JSON({success:true})", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "level": map[string]string{"type": "string", "description": "目标层级"}, "period": map[string]string{"type": "string", "description": "周期标识"}, "taskID": map[string]string{"type": "string", "description": "任务ID"}, "status": map[string]string{"type": "string", "description": "新状态:pending/in_progress/completed/cancelled"}, "title": map[string]string{"type": "string", "description": "新标题(可选)"}, "description": map[string]string{"type": "string", "description": "新描述(可选)"}, "priority": map[string]string{"type": "string", "description": "新优先级:low/medium/high(可选)"}}, "required": []string{"account", "level", "period", "taskID"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawDeleteGoalTask", Description: "删除目标中的某个子任务。返回JSON({success:true})", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "level": map[string]string{"type": "string", "description": "目标层级:daily/weekly/monthly/yearly"}, "period": map[string]string{"type": "string", "description": "周期标识"}, "taskID": map[string]string{"type": "string", "description": "任务ID"}}, "required": []string{"account", "level", "period", "taskID"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawDeleteGoal", Description: "删除整个目标(含所有任务)。返回JSON({success:true})", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "level": map[string]string{"type": "string", "description": "目标层级:daily/weekly/monthly/yearly"}, "period": map[string]string{"type": "string", "description": "周期标识"}}, "required": []string{"account", "level", "period"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawListGoalsByLevel", Description: "列出指定层级的所有目标摘要(可选年份过滤)。返回JSON(list)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "level": map[string]string{"type": "string", "description": "目标层级:daily/weekly/monthly/yearly"}, "year": map[string]interface{}{"type": "number", "description": "年份过滤,如2026,0表示不过滤"}}, "required": []string{"account", "level"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawPrevPeriod", Description: "计算指定层级/周期的上一周期,用于目标导航。返回JSON({prev_period:...})", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"level": map[string]string{"type": "string", "description": "目标层级:daily/weekly/monthly/yearly"}, "period": map[string]string{"type": "string", "description": "周期标识"}}, "required": []string{"level", "period"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawNextPeriod", Description: "计算指定层级/周期的下一周期,用于目标导航。返回JSON({next_period:...})", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"level": map[string]string{"type": "string", "description": "目标层级:daily/weekly/monthly/yearly"}, "period": map[string]string{"type": "string", "description": "周期标识"}}, "required": []string{"level", "period"}}}},

		// 明确的目标查询工具 (自动计算当前周期，无需传 level/period)
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawGetDailyGoal", Description: "获取今日目标(含任务列表和完成进度)。自动计算当前日期，只需传account。返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}}, "required": []string{"account"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawGetWeeklyGoal", Description: "获取本周目标(含任务列表和完成进度)。自动计算当前周，只需传account。返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}}, "required": []string{"account"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawGetMonthlyGoal", Description: "获取本月目标(含任务列表和完成进度)。自动计算当前月，只需传account。返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}}, "required": []string{"account"}}}},
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawGetYearlyGoal", Description: "获取本年目标(含任务列表和完成进度)。自动计算当前年，只需传account。返回JSON(dict)", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}}, "required": []string{"account"}}}},
		...
		{Type: "function", Function: LLMFunction{Name: "Inner_blog.RawMemoryRewriteSection", Description: "重写记忆文件中某个Markdown小节(## 标题段),用于记忆整理;小节不存在则追加。section传不含#的标题文本。返回JSON({success:true})", Parameters: map[string]interface{}{"type": "object", "properties": map[string]interface{}{"account": map[string]string{"type": "string", "description": "账号"}, "file": map[string]string{"type": "string", "description": "记忆文件名:MEMORY/checkpoint/goals/journal_YYYY-MM-DD"}, "section": map[string]string{"type": "string", "description": "小节标题(不含#,如:健康状况)"}, "content": map[string]string{"type": "string", "description": "该小节的新正文(Markdown)"}}, "required": []string{"account", "file", "section", "content"}}}},
